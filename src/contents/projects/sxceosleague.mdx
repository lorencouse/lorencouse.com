...
github: 'https://github.com/lorencouse/sxceosleague'
---
...
<SplitImage>
  <Split>
    <CustomImg
      className='!mb-0'
      publicId='/images/sxceosleague/ss1_wgdcwp.png'
      alt='Screenshot 1'
      width={800}
      height={1271}
    />
  ...
  <Split>
    <CustomImg
      className='!mb-0'
      publicId='/images/sxceosleague/ss2_lrhcjn.png'
      width={800}
      height={1023}
      alt='Web Screenshot'
    />
    <CustomImg
      publicId='/images/sxceosleague/ss3_orb5oe.png'
      width={800}
      height={440}
      alt='Web Screenshot'
    />
...
<CustomImg
  mdx
  publicId='/images/sxceosleague/ss4_hqmquo'
  alt='ss4'
  width={450}
  height={792}
/>
