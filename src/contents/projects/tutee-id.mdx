...
<SplitImage>
  <Split>
    <CustomImg
      className='!mb-0'
      mdx
      publicId='/images/tutee-id/tutee-1_jhx3st'
      alt='tutee-1'
      width={800}
      height={2709}
    />
  ...
  <Split>
    <CustomImg
      className='!mb-0'
      mdx
      publicId='/images/tutee-id/tutee-2_dvybsa'
      alt='tutee-2'
      width={800}
      height={1001}
    />
    <CustomImg
      mdx
      publicId='/images/tutee-id/tutee-3_ikgyzz'
      alt='tutee-3'
      width={800}
      height={1067}
    />
    <CustomImg
      mdx
      publicId='/images/tutee-id/tutee-4_wxgcnh'
      alt='tutee-4'
      width={800}
      height={442}
    />
...
<CustomImg
  mdx
  publicId='/images/tutee-id/gif1_adhmgj'
  alt='gif1'
  width={640}
  height={355}
/>
...
<CustomImg
  mdx
  publicId='/images/tutee-id/gif2_xnzoel'
  alt='gif2'
  width={640}
  height={355}
/>
