...
I started MaleQ in 2012 as a passion project. What began as a small gay mens' sexual health and wellness blog grew into a full adult e-commerce platform selling products to markets around the globe.
...
- **2012:** MaleQ.org is founded as a personal hobby blog.
- **2013:** Launched MaleQ product reviews. Began generating revenue with affiliate marketing.
- **2014:**
- **2015:** MaleQ WooCommerce store launch. MaleQ LLC is officially incorporated.
- **2016:** Launched SuperWare adult toy line. Add Asia warehouse for global fulfillment.
- **2017:** Launched FemaleQ with content and product for female readers.
- **2018:** Rollout of Chinese Language site. Expansion into Taiwan market.
- **2019:** Rollout of Spanish Language site. Expansion into Latin American markets.
- **2020:** Automation of order fulfillment with WooCommerce and partner warehouse APIs
- **2021:** Mister Q and Miss Q
- **2022:**
- **2023:** Automation of content creation with Python scripts using Wordpress and ChatGPT APIs.
...
<SplitImage>
  <Split>
    <CustomImg
      mdx
      className='!mb-0'
      publicId='/images/projects/maleq/prestasi-tesmandiri_zjaaer'
    ...
    <CustomImg
      mdx
      publicId='/images/projects/maleq/acceptance_tvjpmi'
      alt='acceptance'
      width={1280}
      height={908}
    />
  ...
  <Split>
    <CustomImg
      mdx
      className='!mb-0'
      publicId='/images/projects/maleq/zonasi_djqq65'
      alt='zonasi'
      width={1440}
      height={2537}
    />
    <CustomImg
      mdx
      publicId='/images/projects/maleq/not-accepted_gxl5qm'
      alt='not-accepted'
      width={1280}
      height={826}
    />
...
We also configured it with husky so the commit message is checked before committing. You can check the setup on my library about [how to configure husky](https:///images.com/library/husky-commitlint-prettier)

<CustomImg
  mdx
  publicId='/images/projects/maleq/conventional-commit_e8z1qa'
