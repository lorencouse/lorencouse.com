---
title: 'Canker Core'
description: 'A React web app for logging and tracking canker sores. Track, treat, and manage your oral health in one easy place.'
category: 'NextJS'
publishedAt: '2024-09-01'
techs: 'nextjs,typescript,tailwindcss,supabase,vercel'
...
<SplitImage>
  <Split>
    <CustomImg
      mdx
      className='!mb-0'
      publicId='/images/projects/canker-core/ss1_pvyttb.png'
      width={800}
      height={2366}
      alt='Web Screenshot'
    />
  ...
  <Split>
    <CustomImg
      mdx
      className='!mb-0'
      publicId='/images/projects/canker-core/ss2_fpine4.png'
      width={800}
      height={2782}
      alt='Web Screenshot'
    />
...
<CustomImg
  mdx
  publicId='/images/projects/canker-core/opengraph_prie5d'
  alt='opengraph'
  width={315}
  height={227}
/>
